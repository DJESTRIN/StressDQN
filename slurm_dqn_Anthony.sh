...
sbatch --job-name=DQN_test --mem=100G --partition=scu-gpu --gres=gpu:1 --mail-type=BEGIN,END,FAIL --mail-user=dje4001@med.cornell.edu,anp4047@med.cornell.edu --wrap="bash run_dqn_Anthony.sh NoJunk not_random_agent dif_test_off $RANDOMSEED $OUTPUTDIR"
